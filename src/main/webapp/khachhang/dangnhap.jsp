...
<body>
	...
	<main class="form-signin w-100 m-auto">
		...
		<form class="text-center"
			action="<%=request.getContextPath()%>/khach-hang" method="POST">
			<input type="hidden" name="hanhDong" value="dang-nhap" /> <img
				class="mb-4" src="<%=url%>/img/slider/logojava.png" alt=""
				width="72">
			<h1 class="mb-3 fw-normal">ĐĂNG NHẬP</h1>
			<%
			...
			<%
			String thongBaoDangKy = (String) request.getAttribute("thongBaoDangKy");
			if (thongBaoDangKy != null && !thongBaoDangKy.isEmpty()) {
			%>
			...
			<button class="w-100 btn btn-lg btn-primary mb-3" type="submit">Đăng
				nhập</button>
			<a href="<%=request.getContextPath()%>/khachhang/dangky.jsp">Đăng
				kí tài khoản mới</a>
